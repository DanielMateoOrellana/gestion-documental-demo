...
function createInitialState(): DemoState {
  const users: DemoUser[] = [
    {
      id: 1,
      email: 'admin.demo@fiec.espol.edu.ec',
    ...
    {
      id: 2,
      email: 'gestor.demo@fiec.espol.edu.ec',
    ...
    {
      id: 3,
      email: 'lector.demo@fiec.espol.edu.ec',
    ...
    {
      id: 4,
      email: 'ayudante.demo@fiec.espol.edu.ec',
      fullName: 'Ayudante Demo',
      password: 'demo123',
  ...
  const categories: DemoCategory[] = [
    {
      id: 1,
      name: 'Acreditacion',
      description: 'Procesos y evidencias para acreditacion de carreras.',
      isActive: true,
    ...
    },
    {
      ...
      description: 'Documentacion operativa del ciclo academico.',
      isActive: true,
    ...
    },
    {
      id: 3,
      name: 'Laboratorios',
      description: 'Evidencias de practicas y reportes de laboratorio.',
      isActive: true,
  ...
  const processTypes: DemoProcessType[] = [
    {
      ...
      description: 'Consolidacion de evidencias del proceso de evaluacion docente.',
      isActive: true,
      categoryId: 1,
    ...
    {
      id: 2,
      name: 'Syllabus Semestral',
      description: 'Carga, revision y aprobacion de syllabus por materia.',
      isActive: true,
      categoryId: 2,
    ...
    },
    {
      ...
      description: 'Seguimiento de evidencias de laboratorios y practicas.',
      isActive: true,
      categoryId: 3,
  ...
  const templates: DemoTemplate[] = [
    {
      id: 1,
      name: 'Evaluacion Docente 2026',
      description: 'Plantilla base para recopilar evidencias docentes del semestre.',
      isActive: true,
      isLocked: false,
      processTypeId: 1,
      ...
      steps: [
        {
          ...
          templateId: 1,
          order: 1,
          name: 'Planificacion del curso',
          description: 'Carga de planificacion, silabo y cronograma.',
          isMandatory: true,
          createdAt: isoDaysAgo(20),
          updatedAt: isoDaysAgo(5),
        },
        {
          ...
          templateId: 1,
          order: 2,
          name: 'Evidencias de clase',
          description: 'Anexar presentaciones, evaluaciones y asistencia.',
          isMandatory: true,
          createdAt: isoDaysAgo(20),
          updatedAt: isoDaysAgo(5),
        },
        {
          ...
          description: 'Revision final y cierre del expediente.',
          isMandatory: true,
          createdAt: isoDaysAgo(20),
          updatedAt: isoDaysAgo(5),
        },
    ...
    {
      id: 2,
      name: 'Syllabus y Planificacion',
      description: 'Flujo de carga y aprobacion del syllabus institucional.',
      isActive: true,
      isLocked: true,
      processTypeId: 2,
      ...
      steps: [
        {
          ...
          templateId: 2,
          order: 1,
          name: 'Syllabus firmado',
          description: 'Documento principal firmado por el docente.',
          isMandatory: true,
          createdAt: isoDaysAgo(18),
          updatedAt: isoDaysAgo(4),
        },
        {
          ...
          order: 2,
          name: 'Revision de coordinacion',
          description: 'Validacion del coordinador academico.',
          isMandatory: true,
          createdAt: isoDaysAgo(18),
          updatedAt: isoDaysAgo(4),
        },
    ...
    },
    {
      id: 3,
      name: 'Informe de Laboratorio',
      description: 'Plantilla para consolidar evidencias de laboratorios.',
      isActive: true,
      isLocked: false,
      processTypeId: 3,
      ...
      steps: [
        {
          ...
          templateId: 3,
          order: 1,
          name: 'Guia de laboratorio',
          description: 'Guia o practica aprobada.',
          isMandatory: true,
          createdAt: isoDaysAgo(16),
          updatedAt: isoDaysAgo(3),
        },
        {
          ...
          templateId: 3,
          order: 2,
          name: 'Evidencias fotograficas',
          description: 'Fotos y respaldos del laboratorio.',
          isMandatory: false,
          createdAt: isoDaysAgo(16),
          updatedAt: isoDaysAgo(3),
        },
        {
          ...
          description: 'Informe final del responsable.',
          isMandatory: true,
          createdAt: isoDaysAgo(16),
          updatedAt: isoDaysAgo(3),
        },
  ...
  const processes: DemoProcess[] = [
    {
      id: 1,
      title: 'Evaluacion Docente - Programacion I',
      estado: 'PENDIENTE',
      processTypeId: 1,
      templateId: 1,
      responsibleUserId: 2,
      year: 2026,
      month: 4,
      comment: 'Pendiente revision final.',
      dueAt: isoDaysAgo(-4),
      completedAt: null,
      ...
      steps: [
        {
          ...
          estado: 'COMPLETADO',
          comment: 'Planificacion validada.',
          processInstanceId: 1,
          templateStepId: 1,
          dueAt: isoDaysAgo(7),
        ...
        {
          id: 2,
          title: 'Evidencias de clase',
          estado: 'COMPLETADO',
          comment: 'Se subieron diapositivas y asistencia.',
          processInstanceId: 1,
          templateStepId: 2,
          dueAt: isoDaysAgo(4),
        ...
        {
          id: 3,
          title: 'Revision de coordinacion',
          estado: 'PENDIENTE',
          comment: null,
          processInstanceId: 1,
          templateStepId: 3,
    ...
    {
      id: 2,
      title: 'Syllabus 2026-1 - Estructuras de Datos',
      estado: 'COMPLETADO',
      processTypeId: 2,
      templateId: 2,
      responsibleUserId: 2,
      ...
      steps: [
        {
          id: 4,
          title: 'Syllabus firmado',
          estado: 'COMPLETADO',
          comment: 'Documento firmado por el docente.',
          processInstanceId: 2,
          templateStepId: 4,
          dueAt: isoDaysAgo(12),
    ...
    {
      id: 3,
      title: 'Laboratorios de Electronica - Marzo 2026',
      estado: 'PENDIENTE',
      processTypeId: 3,
      templateId: 3,
      responsibleUserId: 4,
      year: 2026,
      month: 3,
      comment: 'Pendiente consolidacion del informe.',
      dueAt: isoDaysAgo(-6),
      completedAt: null,
  ...
  const files: DemoFile[] = [
    createFileRecord({
      id: 1,
      stepId: 1,
      originalName: 'planificacion_programacion_I.pdf',
      ...
      uploadedById: 4,
      body:
        'Documento demo de planificacion del curso Programacion I.\n\n' +
        'Incluye silabo, cronograma y resultados de aprendizaje.',
    }),
    createFileRecord({
      id: 2,
      stepId: 2,
      originalName: 'evidencias_clase_programacion_I.zip',
      ...
      uploadedById: 4,
      body:
        'Paquete demo con evidencias de clase: asistencia, diapositivas y evaluaciones parciales.',
    }),
    createFileRecord({
      id: 3,
      stepId: 4,
      originalName: 'syllabus_estructuras_2026-1.pdf',
      mimeType: 'application/pdf',
      sizeBytes: 143360,
      version: 1,
      ...
      uploadedById: 2,
      body:
        'Syllabus institucional del curso Estructuras de Datos.\n\nDocumento generado para la demo.',
    }),
    createFileRecord({
      id: 4,
      stepId: 5,
      originalName: 'aprobacion_coordinacion.pdf',
      mimeType: 'application/pdf',
      sizeBytes: 102400,
      version: 1,
      uploadedAt: isoDaysAgo(6),
      uploadedById: 1,
      body: 'Constancia demo de aprobacion de coordinacion.',
    }),
    createFileRecord({
      id: 5,
      stepId: 6,
      originalName: 'guia_laboratorio_electronica.pdf',
      mimeType: 'application/pdf',
      sizeBytes: 153600,
      version: 1,
      uploadedAt: isoDaysAgo(10),
      uploadedById: 4,
      body: 'Guia demo de laboratorio de electronica.',
    }),
  ];
  ...
  const auditLogs: DemoAuditLog[] = [
    {
      ...
      details: JSON.stringify({ email: 'admin.demo@fiec.espol.edu.ec' }),
      userId: 1,
    ...
    },
    {
      ...
      entityType: 'FILE',
      entityId: 2,
      description: 'Se cargaron evidencias de clase para Programacion I',
    ...
    },
    {
      ...
      entityId: 5,
      description: 'Se completo la revision de coordinacion del syllabus',
    ...
    },
    {
      ...
      entityId: 3,
      description: 'Se creo el expediente de Laboratorios de Electronica - Marzo 2026',
